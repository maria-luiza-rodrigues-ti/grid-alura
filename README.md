...
O intuito desse projeto foi criar um website da loja fictícia Alura Store, utilizando HTML e CSS, reforçando os conhecimentos em *display grid*. Esse projeto faz parte do curso de CSS Grid: Simplificando layouts da plataforma [Alura](https://www.alura.com.br/).
...
$ git clone https://github.com/maria-luiza-rodrigues-ti/grid-alura
